...
export default function HistoryMemoriesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/submit', {
        ...
        body: JSON.stringify({ category: 'History & Memories', content: fullContent, publishedName, captchaToken }),
      });
        ...
        <div className="rounded-xl bg-white p-8 shadow-xl border-2 border-orange-200">
          ...
          <div className="mb-6">
            <p className="text-gray-800 leading-relaxed mb-2">
              Share stories from the past, historical photos, memories of how the neighborhood used to be, or interesting local history.
            </p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  placeholder="Optional title for your story"
                />
              </div>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  rows={10}
                  className="w-full rounded-lg border-2 border-orange-200 p-3 text-amber-700 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 focus:outline-none placeholder:text-amber-600"
                  placeholder="Share your memories, historical facts, or stories about our neighborhood..."
                />
              </div>
