  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/submit', {
        ...
        body: JSON.stringify({ category: 'Kids\' Corner', content: fullContent, publishedName, captchaToken }),
      });
                ...
                <div className="border-2 border-green-200 rounded-lg p-4 bg-green-50/30">
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      placeholder="e.g. 8"
                    />
                    <p className="mt-1 text-xs text-gray-500">Will show as "Name, age X"</p>
                  </div>
                </div>
