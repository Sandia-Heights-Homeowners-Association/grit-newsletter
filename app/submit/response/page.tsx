...
export default function ResponsePage() {
  ...
  const [referencedArticle, setReferencedArticle] = useState('');
        ...
        <div className="rounded-xl bg-white p-8 shadow-xl border-2 border-orange-200">
          ...
          <div className="mb-6">
            <p className="text-gray-800 leading-relaxed mb-2">
              Respond to articles, letters, or content from previous GRIT issues. Please reference the specific article or month you're responding to.
            </p>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      placeholder="As it appears in newsletter"
                    />
                  </div>
                </div>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  placeholder="Optional title for your response"
                />
              </div>

              <div className="mb-4">
                <label className="mb-2 block font-semibold text-orange-900">
                  Article or Content You're Responding To *
                </label>
                <input
                  type="text"
                  value={referencedArticle}
                  onChange={(e) => setReferencedArticle(e.target.value)}
                  required
                  className="w-full rounded-lg border-2 border-orange-200 p-3 text-amber-700 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 focus:outline-none placeholder:text-amber-600"
                  placeholder='e.g. "November 2025 - On My Mind by Jane Doe" or "October Board Notes"'
                />
              </div>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  rows={8}
                  className="w-full rounded-lg border-2 border-orange-200 p-3 text-amber-700 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 focus:outline-none placeholder:text-amber-600"
                  placeholder="Share your perspective, agreement, disagreement, or additional thoughts..."
                />
              </div>
